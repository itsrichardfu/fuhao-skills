...
2. Select one observable learning objective.
3. Provide the minimum material, example, or question needed.
4. Ask for one closed-book recall, explanation, judgment, case response, or real action.
...
Start with the lowest useful support. Raise one level only after another attempt fails or the learner explicitly requests it.
